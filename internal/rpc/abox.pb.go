...
type PfctlAnchorReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InstanceName  string                 `protobuf:"bytes,1,opt,name=instance_name,json=instanceName,proto3" json:"instance_name,omitempty"`
	RulesContent  string                 `protobuf:"bytes,2,opt,name=rules_content,json=rulesContent,proto3" json:"rules_content,omitempty"` // PF rules to load (only used by PfctlLoadAnchor)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PfctlAnchorReq) Reset() {
	*x = PfctlAnchorReq{}
...
func (x *PfctlAnchorReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PfctlAnchorReq) ProtoMessage() {}

func (x *PfctlAnchorReq) ProtoReflect() protoreflect.Message {
	mi := &file_internal_rpc_abox_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PfctlAnchorReq.ProtoReflect.Descriptor instead.
func (*PfctlAnchorReq) Descriptor() ([]byte, []int) {
	return file_internal_rpc_abox_proto_rawDescGZIP(), []int{13}
}

func (x *PfctlAnchorReq) GetInstanceName() string {
	if x != nil {
...
func (x *PfctlAnchorReq) GetRulesContent() string {
	if x != nil {
...
func (x *MonitorStatus) Reset() {
	*x = MonitorStatus{}
	mi := &file_internal_rpc_abox_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MonitorStatus) Descriptor() ([]byte, []int) {
	return file_internal_rpc_abox_proto_rawDescGZIP(), []int{22}
}
...
const file_internal_rpc_abox_proto_rawDesc = "" +
	...
	"\x06bridge\x18\x01 \x01(\tR\x06bridge\"Z\n" +
	"\x0ePfctlAnchorReq\x12#\n" +
	"\rinstance_name\x18\x01 \x01(\tR\finstanceName\x12#\n" +
	"\rrules_content\x18\x02 \x01(\tR\frulesContent\"\x1d\n" +
	"\aModeReq\x12\x12\n" +
...
var file_internal_rpc_abox_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_internal_rpc_abox_proto_goTypes = []any{
	...
	(*PfctlAnchorReq)(nil),   // 13: abox.PfctlAnchorReq
	(*ModeReq)(nil),          // 14: abox.ModeReq
	(*ProfileReq)(nil),       // 15: abox.ProfileReq
	(*ProfileResp)(nil),      // 16: abox.ProfileResp
	(*DNSStatus)(nil),        // 17: abox.DNSStatus
	(*HTTPStatus)(nil),       // 18: abox.HTTPStatus
	(*KeyLogReq)(nil),        // 19: abox.KeyLogReq
	(*LogLevelReq)(nil),      // 20: abox.LogLevelReq
	(*LogLevelResp)(nil),     // 21: abox.LogLevelResp
	(*MonitorStatus)(nil),    // 22: abox.MonitorStatus
}
