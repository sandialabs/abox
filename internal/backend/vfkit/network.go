...
// On macOS, networking is provided by a per-instance vmnet-helper in HOST mode
// (no NAT; host-only, mirroring libvirt's isolated per-VM bridge), configured as
// part of the vfkit VM launch — networks are not independent resources.
