...
func TestResourceNames(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantNetwork:  "abox-very-long-instance-name-for-testing",
...
func TestStorageDir(t *testing.T) {
	...
	want := filepath.Join(home, "Library", "Application Support", "abox", "images")
	if got := b.StorageDir(); got != want {
