...
func TestBuildArgs_Basic(t *testing.T) {
	...
	assertContainsDevice(t, args, "virtio-net,unixSocketPath=/tmp/vmnet.sock,mac=02:ab:00:11:22:33")
...
func TestBuildArgs_Full(t *testing.T) {
	cfg := VMConfig{
		...
		NetSocketPath: "/data/instances/myvm/vmnet.sock",
	}
	...
	assertContainsDevice(t, args, "virtio-net,unixSocketPath=/data/instances/myvm/vmnet.sock,mac=02:ab:00:aa:bb:cc")
...
func TestBuildArgs_NetSocketPath(t *testing.T) {
	tests := []struct {
		name string
		sock string
		want string
	}{
		{"instance run dir", "/data/instances/dev/run/vmnet.sock", "virtio-net,unixSocketPath=/data/instances/dev/run/vmnet.sock,mac=02:ab:00:11:22:33"},
		{"tmp", "/tmp/vmnet.sock", "virtio-net,unixSocketPath=/tmp/vmnet.sock,mac=02:ab:00:11:22:33"},
	}
